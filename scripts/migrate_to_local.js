...
const runLocalMigration = async () => {
    ...
    try {
        ...
        console.log('🔌 MongoDB Connected for Local Migration...');
        ...
        const absoluteLocalBase = path.isAbsolute(localBase) ? localBase : path.join('D:/uni-bc', localBase);
        
        const targetRoot = path.join(absoluteLocalBase, 'products');
        ...
        for (const product of products) {
                ...
                for (const imgUrl of product.images) {
                    if (imgUrl.includes('cloudinary.com')) {
                        try {
                            ...
                            console.log(`⬇️ [Local] Downloading Image: ${fileName}`);
            ...
            if (product.pdf && product.pdf.includes('cloudinary.com')) {
                try {
                    ...
                    console.log(`⬇️ [Local] Downloading PDF: ${fileName}`);
